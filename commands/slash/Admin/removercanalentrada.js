...
module.exports = {
  ...
  run: async (client, interaction, config, db) => {
    ...
    const latestSetEntrada = await SetEntrada.findOne({ guildId: interaction.guildId }); // Recupera o SetEntrada correspondente ao servidor atual

    if (!latestSetEntrada || channel.id !== latestSetEntrada.channelId) {
    ...
    await SetEntrada.deleteOne({ guildId: interaction.guildId }); // Remove o SetEntrada correspondente ao servidor atual
